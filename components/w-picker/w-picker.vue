	...
	export default {
		...
		methods:{
			...
			bindChange(val){
				...
				let year="",month="",day="",hour="",minute="",second="",starthour="",startminute="",overhour="",overminute="",province,city,area;
				...
				switch(mode){
					...
					case "dateTime":
						...
						break;
					case "time":
						starthour=_this.data.hours[arr[0]];
						startminute=_this.data.minutes[arr[1]];
						overhour=_this.data.hours[arr[2]];
						overminute=_this.data.minutes[arr[3]];
						//second=_this.data.seconds[arr[2]];
						_this.checkArr=[starthour,startminute,overhour,overminute];
						_this.resultStr=`${starthour+':'+startminute+'——'+overhour+':'+overminute}`;
						break;
					case "region":
			...
			initData(){
				...
				let data={};
				let mode=_this.mode;
				let year,month,day,hour,minute,second,province,city,area,starthour,startminute,overhour,overminute;
				if(mode!="region"){
				...
				switch(mode){
					...
					case "dateTime":
						...
						break;
					case "time":
						starthour=data.hours[_this.defaultVal[0]];
						startminute=data.minutes[_this.defaultVal[1]];
						overhour=data.hours[_this.defaultVal[2]];
						overminute=data.minutes[_this.defaultVal[3]];
