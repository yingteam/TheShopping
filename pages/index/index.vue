	...
	export default {
		...
		data() {
			return {
				...
				carouselList: [],
				navList: [
					{text: '便民服务', image: '/static/icons/bianmin.jpg', link: ''},
					{text: '联盟商家', image: '/static/icons/lianmeng.png', link: ''},
					{text: '天天促销', image: '/static/icons/cuxiao.png', link: ''},
					{text: '一卡通', image: '/static/icons/yikatong.png', link: ''},
					{text: '拼团', image: '/static/icons/pintuan.jpg', link: ''},
					{text: '外卖', image: '/static/icons/waimai.jpg', link: ''},
					{text: '礼品商城', image: '/static/icons/lipin.png', link: ''},
					{text: '会员商城', image: '/static/icons/huiyuan.png', link: ''}
				],
				goodsList: []
			};
		},
