<template>
	<view class="container">
		...
		<!-- 广告 -->
		<view class="ad-view m-t">
			<image src="/static/temp/ad-img.jpg" mode="widthFix"></image>
		</view>
		
		<!-- 秒杀楼层 -->
		<view class="seckill-section m-t">
			<view class="s-header">
				<text class="header-title">限时促销</text>
				<!-- <image class="s-img" src="/static/temp/secskill-img.jpg" mode="widthFix"></image> -->
				<text class="tip">8点场  距离结束:</text>
				<text class="hour timer">07</text>
				<text class="minute timer">13</text>
				<text class="second timer">55</text>
				<text class="yticon icon-you" @click="toProListPage"></text>
			</view>
		...
		<view class="seckill-section m-t">
			<view class="s-header">
				<text class="header-title">火爆热销</text>
				<!-- <image class="s-img" src="/static/temp/secskill-img.jpg" mode="widthFix"></image> -->
				<text class="tip">销量:</text>
				<text class="seals">12309</text>
				<image src="../../static/icons/fire.png" style="width: 40upx;height: 40upx;margin-left: 6upx;" mode="scaleToFill"></image>
				<text class="yticon icon-you" @click="toProListPage"></text>
			</view>
			<scroll-view class="floor-list" scroll-x>
				<view class="scoll-wrapper">
		...
		<view class="group-section">
			<swiper class="g-swiper" autoplay circular >
						...
						<view class="t-box">
							...
							<view class="pro-box">
							  	<view class="progress-box">
							  		<progress percent="72" activeColor="#ff6a6a" active stroke-width="6" />
							  	</view>
								<text>6人成团</text>
							</view>
						</view>
	...
	export default {
		data() {
			return {
				...
				carouselList: [],
				navList: [
					{text: '便民服务', image: '/static/icons/bianmin.jpg', link: '/pages/leagueList/list'},
					{text: '联盟商家', image: '/static/icons/lianmeng.png', link: '/pages/league/league'},
					{text: '天天促销', image: '/static/icons/cuxiao.png', link: '/pages/product/list'},
					{text: '一卡通', image: '/static/icons/yikatong.png', link: ''},
					{text: '拼团', image: '/static/icons/pintuan.jpg', link: ''},
					{text: '外卖', image: '/static/icons/waimai.jpg', link: '/pages/leagueList/list'},
					{text: '礼品商城', image: '/static/icons/lipin.png', link: '/pages/product/list'},
					{text: '会员商城', image: '/static/icons/huiyuan.png', link: '/pages/product/list'}
				],
				goodsList: []
			};
		},
